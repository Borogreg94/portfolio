...
class Landing extends React.Component {
	...
	componentDidUpdate(prevProps) {
		if (prevProps.scroll < 3 && this.props.scroll >= 3) Animate.fadeOutTitle();

		if (prevProps.scroll >= 3 && this.props.scroll < 3) Animate.fadeInTitle();
	}
			...
			<>
				<div className='landing'>
					<div className='iconRow'>
						...
						<img className='jsIcon' src={require('./icons/redux.svg')} />
